...
type WeekdayCheckBoxProps = Exclude<ComponentProps<typeof CheckBox> & {}, 'onChange'> & {
  onChangeDispatch: React.Dispatch<TargetWeekdayReducerActionType>;
  id: string;
}

const WeekdayCheckBox = ({onChangeDispatch: onChangeDispatch, ...props}: WeekdayCheckBoxProps) => {
